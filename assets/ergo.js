const POSITION_X_LEFTMOST = -0.5;
const POSITION_X_LEFT = -0.25;
...
// Position is one of 0 (leftmost), 1 (left), or 2 (center), or 3(right), or 4(rightmost)
...
function setupTrees() {
  templateTreeLeftMost    = document.getElementById('template-tree-leftmost');
  ...
  templateTreeRightMost   = document.getElementById('template-tree-rightmost');
  
  treeContainer       = document.getElementById('tree-container');
  templates           = [templateTreeLeftMost, templateTreeLeft, templateTreeCenter, templateTreeRight, templateTreeRightMost];
  
  removeTree(templateTreeLeftMost);
  removeTree(templateTreeLeft);
  removeTree(templateTreeRight);
  removeTree(templateTreeCenter);
  removeTree(templateTreeRightMost);
}
